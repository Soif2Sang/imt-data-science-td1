#!/usr/bin/env python3
"""Train an activity classifier from plantar insole reference data.
...
statistical features, trains a scikit-learn model, and reports accuracy.
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Train a plantar activity classifier from reference insole data."
    )
    ...
    parser.add_argument("--output", type=Path, default=Path("outputs/plantar_activity_model.joblib"))
    parser.add_argument(
        "--mode",
